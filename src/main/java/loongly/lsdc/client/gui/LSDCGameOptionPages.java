    ...
    static void initCPUPages(List<OptionGroup> groups)
    {
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                        .setName(I18n.translate(SystemAndGLInfo.getInstance().getCpuInfo().getVendor()))
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                        .setName(I18n.translate(String.valueOf(SystemAndGLInfo.getInstance().getCpuInfo().getCores())))
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                        .setName(I18n.translate(String.valueOf(SystemAndGLInfo.getInstance().getCpuInfo().getThreads())))
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                        .setName(I18n.translate(String.format( "%.2f",
        ...
        for(int i = 0 ; i < SystemAndGLInfo.getInstance().getGpuInfoList().size() ; i++){
            groups.add(OptionGroup.createBuilder()
                    .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                            ...
                            .build())
                    .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                            .setName(I18n.translate(SystemAndGLInfo.getInstance().getGpuInfoList().get(i).getVendor()) )
                            .setTooltip(I18n.translate("sodium.hardware.vendor"))
                            .setControl(TickBoxControl::new)
                            .setBinding((opts, value) -> LSDCClientMod.caiDan(), opts -> true)
                            //     .setImpact(OptionImpact.LOW)
                            ...
                            .build())
                    .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                            .setName(I18n.translate(String.format("%.2f",SystemAndGLInfo.getInstance().getGpuInfoList().get(i).getVRam())+"GB"))
        ...
        for(int i = 0 ; i < SystemAndGLInfo.getInstance().getMemoryInfoList().size() ; i++){
            groups.add(OptionGroup.createBuilder()
                    .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                            ...
                            .build())
                    .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                            .setName(I18n.translate(SystemAndGLInfo.getInstance().getMemoryInfoList().get(i).getVendor()))
                            .setTooltip(I18n.translate("sodium.hardware.vendor"))
                            .setControl(TickBoxControl::new)
                            .setBinding((opts, value) -> LSDCClientMod.caiDan(), opts -> true)
                            //    .setImpact(OptionImpact.LOW)
                            ...
                            .build())
                    .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                            .setName(I18n.translate(String.format("%.2f",SystemAndGLInfo.getInstance().getMemoryInfoList().get(i).getSize()) +"MB"))
                            .setTooltip(I18n.translate("sodium.memoryInfo.size"))
                            .setControl(TickBoxControl::new)
                            .setBinding((opts, value) -> LSDCClientMod.caiDan(), opts -> true)
                            //    .setImpact(OptionImpact.LOW)
                            ...
                            .build())
                    .add(OptionImpl.createBuilder(boolean.class, lsdcOpts)
                            .setName(I18n.translate(String.format("%.2f",SystemAndGLInfo.getInstance().getMemoryInfoList().get(i).getClockSpeed())+"GHz"))
