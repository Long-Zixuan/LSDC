...
public class LSDCConfigBuilder implements ConfigEntryPoint 
{
    ...
    public void registerConfigLate(ConfigBuilder configBuilder) 
    {
        ...
        configBuilder.registerOwnModOptions()
                ...
                .setIcon(ResourceLocation.parse("lsdc:icon.png"))
                .setVersion("4.10")
                .addPage(configBuilder.createOptionPage()
                        .setName(Component.translatable("sodium.options.pages.lsdc"))
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:sys_info"))
                        ...
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:sys_name"))
                                ...
                                .setStorageHandler(lsdcOpts::save)
                                .setDefaultValue(true))
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:sys_version"))
                                ...
                                .setStorageHandler(lsdcOpts::save)
                                .setDefaultValue(true))
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:jdk_info"))
                                ...
                                .setStorageHandler(lsdcOpts::save)
                                .setDefaultValue(true))
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:jdk_version"))
                                ...
                                .setStorageHandler(lsdcOpts::save)
                                .setDefaultValue(true))
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:gl_info"))
                                ...
                                .setStorageHandler(lsdcOpts::save)
                                .setDefaultValue(true))
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:gl_version"))
                ...
                .addPage(
                        ...
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:cpu_name"))
                                ...
                                .setStorageHandler(lsdcOpts::save)
                                .setDefaultValue(true))
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:cpu_vendor"))
                                ...
                                .setStorageHandler(lsdcOpts::save)
                                .setDefaultValue(true))
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:cpu_cores"))
                                ...
                                .setStorageHandler(lsdcOpts::save)
                                .setDefaultValue(true))
                         .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:cpu_threads"))
                                ...
                                .setStorageHandler(lsdcOpts::save)
                                .setDefaultValue(true))
                        .addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:cpu_frequency"))
    ...
    OptionPageBuilder initGPUPages(ConfigBuilder configBuilder)
    {
        ...
        for(Integer i = 0 ; i < SystemAndGLInfo.getInstance().getGpuInfoList().size() ; i++)
        {
                ...
                optGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:gpu_info" + i.toString()))
                        ...
                        .setStorageHandler(lsdcOpts::save)
                        .setDefaultValue(true));
                optGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:gpu_name" + i.toString()))
                        ...
                        .setStorageHandler(lsdcOpts::save)
                        .setDefaultValue(true));
                optGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:gpu_vendor" + i.toString()))
                        .setName(buildInfoComponent("sodium.hardware.vendor",
                        ...
                        .setStorageHandler(lsdcOpts::save)
                        .setDefaultValue(true));
                optGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:gpu_vram" + i.toString()))
    ...
    OptionPageBuilder initMemoryPages(ConfigBuilder configBuilder)
    {
        ...
        memoryInfoGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:memory_name"))
                ...
                .setStorageHandler(lsdcOpts::save)
                .setDefaultValue(true));
        memoryInfoGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:memory_size"))
        ...
        {
                var optGroup = configBuilder.createOptionGroup();
                optGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:memory" + i.toString()))
                        ...
                        .setStorageHandler(lsdcOpts::save)
                        .setDefaultValue(true));
                optGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:memory_name" + i.toString()))
                        ...
                        .setStorageHandler(lsdcOpts::save)
                        .setDefaultValue(true));
                optGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:memory_vendor" + i.toString()))
                        .setName(buildInfoComponent("sodium.hardware.vendor",
                        ...
                        .setStorageHandler(lsdcOpts::save)
                        .setDefaultValue(true));
                optGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:memory_size" + i.toString()))
                        .setName(buildInfoComponent("sodium.memoryInfo.size",
                        ...
                        .setStorageHandler(lsdcOpts::save)
                        .setDefaultValue(true));
                 optGroup.addOption(configBuilder.createBooleanOption(ResourceLocation.parse("lsdc:memory_clock_speed" + i.toString()))
